...
exports.register = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .send({ success: [{msg: "register successfully.."}] , User: newUser, token });
  } catch (error) {
...
exports.login = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .send({success: [{msg: "login successfully.."}] , User: foundUser, token });
  } catch (error) {
...
exports.deleteUser = async (req, res) => {
  try {
    ...
    res.status(200).send({success: [{msg: " user deleted"}]  });
  } catch (error) {
    res
      .status(400)
      .send({errors: [{msg: "cannot delete  user with this id !!!"}]});
  }
};
...
exports.updateInfos = async(req,res) =>{
  try {
      ...
      res.status(200).send({ success:[{msg : "Updated successfully..."}] , user : updatedUser, token })
...
exports.updatePassword = async (req, res) => {
  ...
  try {
    ...
    return res.status(400).send({ errors: [{ msg: "Can not update ... Try again" }] });
  }
};
